...
public class NormalLane extends PriorityQueue<Customer> {
    ...
    public void update(double time) {
        // System.out.println("Update activated." + time);
        if (!this.isEmpty()) {
            currentWaitTime = 0;
        } else {
            if (this.peek() != null) {
        ...
        // checks if sim time, or time that's passed = calculated checkout time+time of
        // arrival.
        // schedule checkout events and add to main event queue? We will only know
        // how long it will take for a customer to check out once they're added to the
        // line..
    }
    ...
    // //Check how long it will take for the given customer to be checked out. make
    // new
